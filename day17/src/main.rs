...
// I rolled my own BitVector class after having difficulty with the BitVec crate.  In particular,
// I kept using BitVec::splice to attempt to set a single bit, and BitVec::splice kept performing
...
impl Voxels {
    ...
    fn count_bit(&self, x: isize, y: isize, z: isize) -> usize {
